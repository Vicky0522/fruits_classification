                        ...
                        THFloatTensor * features, THFloatTensor * rois, THFloatTensor * output)
{
    ...
    {
        int roi_batch_ind = n; // rois_flat[index_roi + 0];
        int roi_start_w = round(rois_flat[index_roi + 0] * spatial_scale);
        int roi_start_h = round(rois_flat[index_roi + 1] * spatial_scale);
        int roi_end_w = round(rois_flat[index_roi + 2] * spatial_scale);
        int roi_end_h = round(rois_flat[index_roi + 3] * spatial_scale);
